...
const App: FC = async () => {
  ...
  // *Ekrana basılacak kart dizisi
  const cards: InfoItem[] = [
    {
      icon: icon1,
      label: "Toplam Kullanıcı",
      value: values.total_users * 223,
    },
    {
      icon: icon2,
      label: "Toplam Sipariş",
      value: values.total_orders * 339,
    },
    {
      icon: icon3,
      label: "Toplam Satış",
      value: (values.total_price * 26).toLocaleString() + "$",
    },
    {
      icon: icon4,
      label: "Ürün Sayısı",
      value: values.total_products * 423,
    },
  ];
